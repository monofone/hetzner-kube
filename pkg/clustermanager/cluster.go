...
func (manager *Manager) InstallMasters() error {
	...
	commands := []NodeCommand{
		...
		{"install flannel", "kubectl apply -f https://raw.githubusercontent.com/monofone/flannel/monofone-default-iface/Documentation/kube-flannel.yml"},
		{"configure flannel", "kubectl -n kube-system patch ds kube-flannel-ds-amd64 --type json -p '[{\"op\":\"add\",\"path\":\"/spec/template/spec/tolerations/-\",\"value\":{\"key\":\"node.cloudprovider.kubernetes.io/uninitialized\",\"value\":\"true\",\"effect\":\"NoSchedule\"}}]'"},
